...
class RegistrationPage {
	...
	public  void Registration() throws IOException {
		...
		FileReader recoveryfile = new FileReader("/home/subhash/Documents/IDEA_CODES/DSA_Project/src/Recoveryfile");
		...
		if(login_object1.state) {
			...
			if (recoveryFile_list.contains(login_object1.Rollno)) {
				...
				FileWriter Recoveryfile_writer = new FileWriter("/home/subhash/Documents/IDEA_CODES/DSA_Project/src/Recoveryfile", true); // here true means appending in file not over wrtiting
