...
public class CheckinActivity  {
    public  String  loginActivity() throws IOException {
        ...
        FileWriter file1 = new FileWriter("/home/subhash/Documents/IDEA_CODES/DSA_Project/src/LogininActivity",true);
    ...
    public void LoginActivity() throws IOException {
        ...
        LoginPage l1 = new LoginPage();
        FileReader f1 = new FileReader("/home/subhash/Documents/IDEA_CODES/DSA_Project/src/LogininActivity");
